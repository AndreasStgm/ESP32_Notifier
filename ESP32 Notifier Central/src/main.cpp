...
uint8_t macAddressAndreas[] = {0x3C, 0x61, 0x05, 0x13, 0x74, 0x40};
uint8_t macAddressJasper[] = {0x30, 0xAE, 0xA4, 0x9B, 0xB4, 0x14};
uint8_t macAddressBart[] = {0x30, 0xAE, 0xA4, 0x96, 0xC8, 0x90};
